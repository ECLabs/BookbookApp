 ...
 * Copyright (c) 2009-2011 by BookbookApp, Inc. All Rights Reserved.
...
//@interface BookbookAppObject : NSObject
//@end

@interface BookbookAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[BookbookAppObject class]])
		{
			for (NSString *key in [[(BookbookAppObject*)o modules] allKeys])
			{
