...
/**
 The base class for all BookbookApp modules
 */
...
/**
 BookbookApp Platform calls this method on startup.
 */
-(void)startup;

/**
 BookbookApp Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 BookbookApp Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 BookbookApp Platform calls this method on resume.
 @param sender The sender of the event.
 */
