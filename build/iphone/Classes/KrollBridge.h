...
@interface BookbookAppObject : KrollCoverageObject {
#else
@interface BookbookAppObject : KrollObject {
#endif
@private
...
extern NSString * BookbookApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	BookbookAppObject *_bookbookapp;
	BOOL shutdown;
