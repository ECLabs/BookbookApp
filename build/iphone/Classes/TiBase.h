...
// in simulator we redefine to format for BookbookApp Developer console
...
{\
	NSString * exceptionName = [@"org.bookbookapp." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.bookbookapp";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIBookbookAppNativeItemNone = -1, 
	UIBookbookAppNativeItemSpinner = -2,
	UIBookbookAppNativeItemProgressBar = -3,
	
	UIBookbookAppNativeItemSlider = -4,
	UIBookbookAppNativeItemSwitch = -5,
	UIBookbookAppNativeItemMultiButton = -6,
	UIBookbookAppNativeItemSegmented = -7,
	
	UIBookbookAppNativeItemTextView = -8,
	UIBookbookAppNativeItemTextField = -9,
	UIBookbookAppNativeItemSearchBar = -10,
	
	UIBookbookAppNativeItemPicker = -11,
	UIBookbookAppNativeItemDatePicker = -12,
	
	UIBookbookAppNativeItemInfoLight = -13,
	UIBookbookAppNativeItemInfoDark = -14,
	
	UIBookbookAppNativeItemDisclosure = -15,
	
	UIBookbookAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all BookbookApp instances of
